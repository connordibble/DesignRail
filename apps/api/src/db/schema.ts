...
export const componentIntents = sqliteTable(
  'component_intents',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [index('component_intents_example_id_idx').on(table.exampleId)],
);

export const componentMappings = sqliteTable(
  'component_mappings',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [index('component_mappings_intent_id_idx').on(table.intentId)],
);

export const complianceFindings = sqliteTable(
  'compliance_findings',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [
    index('compliance_findings_mapping_id_idx').on(table.mappingId),
    index('compliance_findings_severity_message_idx').on(table.severity, table.message),
  ],
);
...
export const reviewDecisions = sqliteTable(
  ...
  (table) => [
    index('review_decisions_mapping_id_created_at_idx').on(table.mappingId, table.createdAt),
  ],
);
...
export const exports = sqliteTable(
  ...
  (table) => [index('exports_mapping_id_idx').on(table.mappingId)],
);
